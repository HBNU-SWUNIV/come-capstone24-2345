const ChatTrue = () => {
  return (
    <div className='w-full h-[calc(100%_+_100px)]'>
      <div className='card p-[20px] text-start'>
        ...
        <div className='w-full flex justify-between my-[20px]'>
          <div className='w-[22%] aspect-square card p-[20px]'>
            <img className='size-full' src='/mbti/I.svg' />
          </div>
          <div className='w-[22%] aspect-square card p-[20px]'>
            <img className='size-full' src='/mbti/S.svg' />
          </div>
          <div className='w-[22%] aspect-square card p-[20px]'>
            <img className='size-full' src='/mbti/F.svg' />
          </div>
          <div className='w-[22%] aspect-square card p-[20px]'>
            <img className='size-full' src='/mbti/P.svg' />
          </div>
        </div>
        ...
        <div className='w-[calc(100%_+_20px)] p-[20px] overflow-x-scroll translate-x-[-20px]'>
          <div className='flex w-min'>
            <div className='w-max card p-[20px] mr-[8px]'>
              <span>🎱 당구</span>
            </div>
            <div className='w-max card p-[20px] mr-[8px]'>
              <span>🎳 볼링</span>
        ...
        <div className='w-ful flex flex-col items-center mb-[20px]'>
